...
class Test(unittest.TestCase):
    ...
    def test_easy_algebra__linear_2d(self):
        ...
        assert lookup_value(
            solve_system(append(append([], f[0]), f[1])), f[2]
        ) == Value(4)
    ...
    def test_algebra__polynomial_roots_3(self):
        ...
        assert lookup_value(solve_system(append([], f[1])), f[0]) == {
            Value(-1),
            Value(1 / 3),
            Value(997),
        }
    ...
    def test_algebra__polynomial_roots_composed_1(self):
        ...
        assert lookup_value(solve_system(append([], equation)), f[4]) == {
            Value(-1 / 3),
            Value(1),
        }
    ...
    def test_polynomials_evaluate(self):
        ...
        assert function_application(f[0], f[1]) == Value(-1)
