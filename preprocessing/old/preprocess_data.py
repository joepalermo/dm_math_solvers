...
# preprocess
preprocess_data(
    train_easy_filepaths, char2idx, output_dirpath=train_easy_preprocessed_dirpath
)
preprocess_data(
    train_medium_filepaths, char2idx, output_dirpath=train_medium_preprocessed_dirpath
)
preprocess_data(
    train_hard_filepaths, char2idx, output_dirpath=train_hard_preprocessed_dirpath
)
preprocess_data(
    interpolate_filepaths,
    char2idx,
    output_dirpath=test_interpolate_preprocessed_dirpath,
)
preprocess_data(
    extrapolate_filepaths,
    char2idx,
    output_dirpath=test_extrapolate_preprocessed_dirpath,
)
